...
<head>
  ...
  <!-- CSS Diagrama de Gantt -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/admin/gantt/style.css" />
  ...
  <!-- CSS FILEUPLOAD -->
  <!-- Bootstrap Image Gallery styles -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/admin/bootstrap/bootstrap-image-gallery.min.css">
  <!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/admin/jquery.fileupload-ui.css">
  <!-- END FILEUPLOAD-->
  ...
  <!-- Tab -->
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/bootstrap/bootstrap-tab.js"></script>
  <!-- Acordeon -->
  ...
  <!-- JS FILEUPLOAD -->
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/bootstrap/bootstrap.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/tmpl.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/vendor/jquery.ui.widget.js"></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/load-image.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/canvas-to-blob.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/bootstrap-image-gallery.min.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/jquery.iframe-transport.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/jquery.fileupload.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/jquery.fileupload-ip.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/jquery.fileupload-ui.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/locale.js" ></script>
  <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/admin/fileupload/main.js" ></script>
  <!-- END FILEUPLOAD-->
  ...
  <script language="javascript" type="text/javascript">
    ...
    base_url='http://www.it7.info/index.php/';
      ...
      <div class="container-fluid">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <p class="navbar-text pull-right">
            ...
            <a href="http://www.it7.info/" onclick="window.open(this.href); return false;" title="Muestra el sitio web en línea (abre una ventana nueva)" class=""> Ver sitio en linea</a> | Sesión iniciada como
