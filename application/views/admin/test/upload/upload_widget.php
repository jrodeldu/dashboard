        ...
        <div class="span12">
            <div class="widget-header">
                ...
                <h3>Upload</h3>
                    ...
                    <div id="new-article" class="widget-content">
                        <h1>Listado</h1>

                        <div id="upload-img">
                            <h2>Upload (Formatos : JPG, PNG, GIF)</h2>

                            <form id="fileupload" action="<? echo base_url() . 'admin/upload/upload_img'; ?>" method="POST" enctype="multipart/form-data">
