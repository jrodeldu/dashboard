    ...
    <div class="row-fluid">
        <div class="widget">
            <div class="widget-header">
                ...
                <h3>Modifique esta tarea: <?php echo $results->entradilla ?></h3>
            </div>
            <div class="widget-content nopadding">
                <form id="tarea" name="tarea" class="form-horizontal myform" action="<?php echo base_url( $this->uri->uri_string ) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="proyecto" maxlength="255" name="proyecto" value="<?php echo $results->proyecto ?>" title="Escriba el nombre del proyecto" class="text validate[required]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="entradilla">(*) Descripción breve:</label>
                        <div class="controls">
                            <input type="text" id="entradilla" maxlength="255" placeholder="" name="entradilla" value="<?php echo $results->entradilla ?>" title="Escriba una descripción breve" class="text validate[required]"/>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="tipo" id="tipo" class="text validate[required]" >
                              <option value="<?php echo $results->tipo ?>"><?php echo $results->tipo ?></option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="prioridad" id="prioridad" class="text validate[required]">
                              <option value="<?php echo $results->prioridad ?>"><?php echo $results->prioridad ?></option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="horas" maxlength="4" name="horas" value="<?php echo $results->horas ?>" title="Escriba las horas dedicadas al proyecto proyecto" class="text validate[required]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="descripcion">(*) Descripción:</label>
                        <div class="controls">
                            <textarea id="content" name="descripcion" rows="15" cols="70" title="Escriba la descripción de la tarea" class="text validate[required]"><?php echo $results->descripcion ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="solucion">Solución:</label>
                        <div class="controls">
                            <textarea id="content-2" name="solucion" rows="15" cols="70" title="Escriba la solución de la tarea" class=""><?php echo $results->solucion ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
